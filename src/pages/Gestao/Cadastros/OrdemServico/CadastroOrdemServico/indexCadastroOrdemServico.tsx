...
import { FaPen, FaMinus, FaPencilAlt, FaTrash } from 'react-icons/fa';
...
import {
  DatePickerFilter,
  BtnData,
} from '../../Demo/CadastroDemo/cadastroDemoStyle';
...
import { schemaOrdemServico } from '../../../../../validacao/Cadastros/ordemServico';
import { DivCarrossel } from '../../../../../components/SliderComponentMod/styled-slider-component-mod';
...
const CadastroOrdemServico: React.FC = () => {
  ...
  const exibirMensagem = (
    ...
    switch (type) {
      case 'erro':
        toast(mensagem, TipoMensagem.ERRO);
        break;
      case 'sucesso':
        toast(mensagem, TipoMensagem.SUCESSO);
        break;
      case 'info':
        toast(mensagem, TipoMensagem.INFO);
        break;
      default:
        toast(mensagem, TipoMensagem.ERRO);
        break;
  ...
  const saveOSItems = async (item: any) => {
    ...
    try {
      ...
      console.log('saveOSItems -> quantidadeLimpa', quantidadeLimpa);
  ...
  const saveEditedItem = async (product: any) => {
    ...
    console.log('saveEditedItem -> quantidade', quantidade);
